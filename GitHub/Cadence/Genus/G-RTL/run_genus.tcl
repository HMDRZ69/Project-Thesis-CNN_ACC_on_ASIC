...
set RTL_DIR  /home/rah47472/asic_project/Genus/G-RTL
...
# Slew / capacitance limits for IHP SG13G2 130nm
# 1.0 ns max transition, 0.5 pF max load — conservative for this node
...
puts "=== SRAM instances BEFORE synthesis (must show 4 instances) ==="
...
puts "=== SRAM instances AFTER synthesis (must still show 4 instances) ==="
puts [get_db hinsts *sram*]
puts [get_db hinsts *u_lower*]
puts [get_db hinsts *u_upper*]
