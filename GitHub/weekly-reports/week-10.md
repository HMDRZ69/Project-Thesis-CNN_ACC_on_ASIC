...
- Designed and implemented the **top-level controller FSM**:
  ...
  - [Cadence/Xcelium/X-RTL/controller_fsm.md](../Cadence/Xcelium/X-RTL/controller_fsm.md)
...
- Implemented a **dedicated SystemVerilog testbench** for `controller_fsm`:
  ...
  - [Cadence/Xcelium/X-RTL/tb_controller_fsm.md](../Cadence/Xcelium/X-RTL/tb_controller_fsm.md)
