...
module controller_fsm (
    ...
    // Handshake inputs
    input  wire logic start,       // Single-cycle pulse to begin processing
    input  wire logic conv_done,   // Asserted for one cycle when Conv engine finishes
    input  wire logic pool_done,   // Asserted for one cycle when Pool engine finishes
