...
module cnn_top (
    ...
    //
    // Port mapping:
    //   mac_valid    ← addr_gen: high in AG_TAPS state
    //   acc_clear    ← addr_gen: high on first tap group of each pixel
    //   act_data     ← SRAM read-data (lane 0 real, lanes 1-3 zero)
    ...
    //   out_valid    → conv_out_valid → sram_*_we (1-cycle aligned with data)
    // =========================================================================
