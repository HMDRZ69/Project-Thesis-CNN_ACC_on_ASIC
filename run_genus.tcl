...
##############################################################################
# 5. PRESERVE SRAM INSTANCES — prevent Genus from removing as dead logic
#
...
# Preserve the macro definition — prevents internal optimisation
set_db [get_db designs RM_IHPSG13_1P_4096x8_c3_bm_bist] .preserve true
...
# Preserve SRAM wrapper instances after generic synthesis
# (instance-level preserve requires at least partially mapped state)
set_db [get_db hinsts cnn_top/u_sram_a] .preserve map_size_ok
set_db [get_db hinsts cnn_top/u_sram_b] .preserve map_size_ok
set_db [get_db hinsts cnn_top/u_sram_a/u_lower] .preserve map_size_ok
set_db [get_db hinsts cnn_top/u_sram_a/u_upper] .preserve map_size_ok
set_db [get_db hinsts cnn_top/u_sram_b/u_lower] .preserve map_size_ok
set_db [get_db hinsts cnn_top/u_sram_b/u_upper] .preserve map_size_ok
