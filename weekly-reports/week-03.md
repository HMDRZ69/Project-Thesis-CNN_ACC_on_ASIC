...
- Added design artifacts to the repository:
  - RTL: `Cadence/Xcelium/X-RTL/and_gate.v`, `Cadence/Xcelium/X-RTL/halfadder.v`
  - Testbenches: `Cadence/Xcelium/X-RTL/and_tb.v`, `Cadence/Xcelium/X-RTL/tb_half_adder.v`
