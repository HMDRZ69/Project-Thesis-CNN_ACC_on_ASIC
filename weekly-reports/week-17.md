...
- Re-ran the `pool_engine` unit test suite to confirm the fixes introduced no regressions:
  * Compile: `xrun -sv X-RTL/pool_engine.sv X-RTL/tb_pool_engine.sv`
...
- [Cadence/Xcelium/X-RTL/pool_engine.sv](../Cadence/Xcelium/X-RTL/pool_engine.sv) — 3 fixes (S_DONE exit, counter reset, pool_done de-assertion)
- [Cadence/Xcelium/X-RTL/tb_cnn_top.sv](../Cadence/Xcelium/X-RTL/tb_cnn_top.sv) — 3 fixes (compile separation, pool assertion, conv_out_v guard)
